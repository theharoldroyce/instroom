...
const LOGO_PATH = path.join(process.cwd(), "public/images/instroomLogo.png")

const logoAttachment = {
  filename: "instroomLogo.png",
  path: LOGO_PATH,
  cid: LOGO_CID,
}
        ...
        <html>
          ...
          <body>
            <div class="container">
              <div class="header">
                <div class="logo">
                  <img src="cid:${LOGO_CID}" alt="Instroom Logo" width="50" height="50" />
                </div>
